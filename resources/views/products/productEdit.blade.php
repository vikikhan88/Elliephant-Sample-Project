                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-full">
                                ...
                                <p class="mt-3 text-sm leading-6 text-gray-600">Write a Description about Product.</p>
                            </div>

                            <div class="col-span-full">
                                <label for="photo" class="block text-sm font-medium leading-6 text-gray-900">Product
                                    Image</label>
                            ...
                            <div class="col-span-full">
                                <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Feature
                                    Images</label>
                                <div
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                <label for="shipping_cost"
                                    class="block text-sm font-medium leading-6 text-gray-900">Shipping Cost</label>
                                <div class="mt-2">
                                    <input type="text" value="{{ $product->shipping_cost }}" name="shipping_cost"
                                        id="shipping_cost" autocomplete="shipping_cost"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 space-y-10">
                            <fieldset>
                                <legend class="text-sm font-semibold leading-6 text-gray-900">Product Status</legend>
                                <div class="mt-6 space-y-6">
                                    <div class="relative flex gap-x-3">
                                        ...
                                        <div class="text-sm leading-6">
                                            <label for="product_status" class="font-medium text-gray-900">Active</label>
